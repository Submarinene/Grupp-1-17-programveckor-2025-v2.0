...
public class TheodorBossBullet : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        {
            PlayerCollisions playerCollisions = collision.gameObject.GetComponent<PlayerCollisions>();
            Collision2D collision2D = new Collision2D();
            playerCollisions.OnCollisionEnter2D(collision2D);
        }
